...
import com.example.frontend.util.BigDecimalSerializer
import com.example.frontend.util.InstantSerializer
...
class SubscriptionApiClient(
    private val baseUrl: String = "http://localhost:3000/api/subscriptions"
) {
